	  ...
	  private static final String JCR_REP_HOME = "jcr.rep.home";
	    ...
	    public RepositoryConfig create() throws Exception {
	        ...
	        try{
	            ...
	            InputStream is = JackrabbitConfig.class.getClassLoader().getResourceAsStream(propertiesFilename);
	            if (is != null) {
	                try {
	            ...
	            is = JackrabbitConfig.class.getClassLoader().getResourceAsStream(configFilename);
	            if (is == null) {
